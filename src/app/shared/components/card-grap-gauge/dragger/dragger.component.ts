...
export class DraggerComponent implements AfterViewInit, OnChanges {
  ...
  getUrlPath(id: string) {
    ...
    const url = `url(${baseHref}${path}${id}${this.svgControlId})`;
    // console.log(`🚀 ~ file: dragger.component.ts ~ line 126 ~ DraggerComponent ~ getUrlPath ~ url`, url);
    return url;
  }

  private invalidate(): void {
    this.bottomAngleRad = DraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
